...
void QMC5883L::_writeReg(byte r, byte v){
...
**/
// Set chip mode
void QMC5883L::setMode(byte mode, byte odr, byte rng, byte osr){
...
// 1 = Basic 2 = Advanced
void QMC5883L::setSmoothing(byte steps, bool adv){
	_smoothUse = true;
...
*/
byte QMC5883L::getBearing(int azimuth){
